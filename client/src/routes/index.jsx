...
// const OpportunityKanban    = lazy(() => import('@/pages/crm/opportunities/OpportunityKanban'))
const OpportunityDetail = lazy(() => import('@/pages/crm/opportunities/OpportunityDetail'))
...
const AttendanceLogs = lazy(() => import('@/pages/hr/attendance/AttendanceLogs'))
const LeaveRequests = lazy(() => import('@/pages/hr/leaves/LeaveRequests'))
const PayrollRuns = lazy(() => import('@/pages/hr/payroll/PayrollRuns'))
const FinanceOverview = lazy(() => import('@/pages/finance/overview/FinanceOverview'))
const ExpensesList = lazy(() => import('@/pages/finance/expenses/ExpensesList'))
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: '/crm/accounts/:id/edit', element: <S><AccountEdit /></S> },

          { path: '/crm/contacts', element: <S><ContactsList /></S> },
          { path: '/crm/opportunities', element: <S><OpportunitiesList /></S> },
          { path: '/crm/opportunities/kanban', element: <S><OpportunityKanban /></S> },
          { path: '/crm/opportunities/:id', element: <S><OpportunityDetail /></S> },

          // HR
          { path: '/hr/employees', element: <S><EmployeesList /></S> },
          { path: '/hr/employees/:id', element: <S><EmployeeDetail /></S> },
          { path: '/hr/employees/:id/edit', element: <S><EmployeeEdit /></S> },
          { path: '/hr/attendance', element: <S><AttendanceLogs /></S> },
          { path: '/hr/leaves', element: <S><LeaveRequests /></S> },
          { path: '/hr/payroll', element: <S><PayrollRuns /></S> },

          // Finance
          { path: '/finance', element: <S><FinanceOverview /></S> },
          { path: '/finance/expenses', element: <S><ExpensesList /></S> },
          { path: '/finance/ledger', element: <S><GeneralLedger /></S> },
          ...
          { path: '/support', element: <S><TicketsList /></S> },
          { path: '/support/:id', element: <S><SupportDetail /></S> },
