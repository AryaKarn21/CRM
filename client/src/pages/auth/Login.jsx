      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 flex-col justify-between p-12 relative overflow-hidden"
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-16">
            ...
            <div>
              <p className="text-white font-bold text-lg leading-none">OS Group CRM</p>
          ...
          <p className="text-slate-400 text-lg leading-relaxed max-w-md">
            Multi-company CRM, HR, Finance, Inventory and more — unified in a single enterprise platform.
          </p>
        </div>
        <div className="relative grid grid-cols-3 gap-4">
          {[['15+', 'Modules'], ['Multi', 'Company'], ['Real-time', 'Analytics']].map(([val, label]) => (
            <div key={label} className="rounded-xl p-4 border border-white/10 bg-white/05">
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-6 lg:hidden">
              ...
              <p className="font-bold" style={{ color: 'var(--text-primary)' }}>OS Group CRM</p>
            </div>
            <h2 className="text-2xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>Sign in to your account</h2>
            <p className="text-[13px]" style={{ color: 'var(--text-muted)' }}>Enter your credentials to access the platform</p>
          </div>
