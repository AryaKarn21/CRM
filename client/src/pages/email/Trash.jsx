...
export default function Trash() {
  ...
  /*
   * Only show the full error state when there is
   * no previously cached data to keep displaying.
   */
  if (isError && !data) {
    return (
      <div
  ...
  return (
    <div className="flex h-[calc(100dvh-180px)] min-h-[500px] min-w-0 overflow-hidden">
      ...
      {/* Email Preview */}
      <section
        aria-label="Deleted email preview"
        className={[
