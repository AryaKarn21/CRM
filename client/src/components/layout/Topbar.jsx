  ...
  return (
    ...
    >
      ...
      >
        ...
        <kbd className="ml-auto flex items-center gap-1 text-[10px] px-1.5 py-0.5 rounded" style={{ background: 'var(--border)', color: 'var(--text-muted)' }}>
          <Command size={10} /> K
        </kbd>
      </button>
        ...
        <div className="relative">
          ...
          {profileOpen && (
            ...
            >
              ...
              <button className="w-full text-left px-4 py-2.5 text-[13px] hover:bg-[var(--surface-2)] transition-colors" style={{ color: 'var(--text-secondary)' }}>
                Profile Settings
              </button>
              <button onClick={handleLogout} className="w-full text-left px-4 py-2.5 text-[13px] text-red-500 hover:bg-red-50 transition-colors">
                Sign Out
              </button>
            </div>
          )}
